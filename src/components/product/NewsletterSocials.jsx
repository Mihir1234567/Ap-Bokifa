            ...
            <div className="mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-gray-600 text-base leading-relaxed max-w-xl">
                        Subscribe to our newsletter and stay updated on latest
                        offers, discounts and events near you.
                    </p>
                </div>
                ...
                <div className="flex flex-col lg:flex-row items-center lg:items-start justify-end gap-6 w-full">
                    ...
                    >
                        <div className="relative">
                            ...
                            <button
                                type="submit"
                                className="absolute right-1 top-1/2 -translate-y-1/2 bg-transparent text-green-800 font-medium px-5 py-2 rounded-full inline-flex items-center gap-2 hover:underline focus:outline-none"
                    ...
                    <div className="flex gap-3 items-center justify-center lg:justify-start w-full lg:w-auto">
                        ...
                        <a
                            href="#"
                            aria-label="Facebook"
                            className="inline-flex items-center justify-center w-12 h-12 p-1 bg-white  rounded-sm  hover:shadow-md transition-transform transform hover:-translate-y-0.5"
                        >
