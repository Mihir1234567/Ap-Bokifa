...
const ProductCard = ({ product }) => {
    ...
    return (
        // w-full allows the card to take the responsive width set by its parent
        <div className="group flex flex-col flex-shrink-0 w-full bg-white rounded-xl shadow-none hover:shadow-xl hover:translate-y-[-4px] transition-all duration-300 ease-in-out">
