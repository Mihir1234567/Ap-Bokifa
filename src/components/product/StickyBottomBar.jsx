      ...
      <div className="max-w-8xl mx-auto px-5 sm:px-6 lg:px-18">
        <div className="flex items-center justify-between h-auto md:h-20 py-4 md:py-0 flex-col md:flex-row gap-4 md:gap-0">
          ...
          <div className="flex items-center gap-4 w-full md:w-auto">
            ...
            <button
              className="bg-black text-white font-bold py-2 px-6 rounded-full border border-black hover:bg-gray-100 hover:text-black transition-colors whitespace-nowrap w-1/2 md:w-auto"
