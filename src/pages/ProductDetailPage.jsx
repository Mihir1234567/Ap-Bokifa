...
// Green Star Rating Component (for review summary)
        ...
        <div className="w-full">
            ...
            {hasMoreReviews && (
                <div className="flex justify-center mt-8">
                    ...
                    >
                        Show More Reviews (
                        {sortedReviews.length - reviewsToShow} more)
                    </button>
                </div>
            )}
...
const ProductDetailPage = () => {
    ...
    useEffect(() => {
        ...
        if (foundProduct) {
            ...
            // Scheduling this asynchronously ensures React finishes the
            // current render/commit before other components receive the
            // update and call setState.
            setTimeout(() => {
                try {
                    addRecentlyViewed(foundProduct);
                } catch (e) {
                    // swallow errors from recently viewed to avoid
                    // breaking the product page render
                    console.error(e);
                }
            }, 0);
    ...
    // Create thumbnail URLs (product image - repeat for carousel)
    ...
    // You may also like products (bestselling)
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="max-w-8xl mx-auto sm:px-6 lg:px-8 py-4">
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <div className="mb-8">
                            ...
                            <div className="flex space-x-3">
                                {Object.keys(FORMAT_MULTIPLIERS).map(
                                    (format) => (
                                        <button
                                            key={format}
                        ...
                        <div className="mt-6 text-s text-gray-500">
                            <p>
                                <strong>Categories:</strong> Books, Books New,
                                Fantasy, Fiction, Kids Books, Non Fiction
                            </p>
                            <p className="mt-2">
                ...
                {/* Description, Additional Info, Reviews Tabs Section */}
                        ...
                        {activeTab === "Description" && (
                            <div>
                                ...
                                <p>
                                    ...
                                    West Point, Bryce showed her how much there
                                    was to love about the wind-swept beach
                                    town--and introduced her to photography, a
                                    passion that would define the rest of her
                                    life. A collection of 10 well-researched
                                    board books to introduce a wide range of
                                    learning topics and everyday objects to the
                                    little scholars. The topics included in the
                                    set are - ABC, Numbers, Shapes, Colours,
                                    Wild Animals, Farm Animals and Pets, Birds,
                        ...
                        {activeTab === "Additional Information" && (
                            <div>
                                <p className="mb-4 opacity-80">
                                    <p>
                                        By changing our most important processes
                                        and
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        increased use of more sustainable fibers
                                        to the use of more
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        efficient waste management in our value
                                        chain.
                                    </p>
                                </p>
                                <a
                                ...
                                {reviewSubmitted && (
                                    <div className="w-full max-w-4xl mx-auto p-4 mb-8 bg-green-50 border-2 border-green-200 rounded-lg">
                                        ...
                                        <p className="text-sm text-green-700 mb-4">
                                            Thank you! Please refresh the page
                                            in a few moments to see your review.
                                            You can remove or edit your review
                                            by logging into{" "}
                                            <a
                                                href="#"
