...
export const ProductLayoutRightThumbs = () => {
        ...
        try {
            ...
            const defaultReviews = [
                // ⭐️ MOCK REVIEWS FOR DEMONSTRATION (12 REVIEWS TOTAL)
                {
                    ...
                    rating: 5,
                    title: "Amazing book!",
                    review: "This book was truly excellent and exceeded all my expectations. (Review 1)",
                    name: "ribiigh",
                    email: "a@b.com",
                ...
                // ... (other mock reviews) ...
                {
                    ...
                    review: "The quality was poor and the content was not what I expected. Would not recommend.",
                    name: "Anonymous",
                    email: "c@d.com",
                    mediaFile: null,
                },
    ...
    const calculatePriceDetails = (format) => {
        ...
        const productFormatMultiplier =
            formatPrices[mainProduct.format] || 1.0;
                ...
                <div className="flex flex-col lg:flex-row gap-12 bg-white rounded-lg">
                    ...
                    <div className="lg:w-1/2">
                        <h1 className="text-4xl font-serif font-light text-gray-900 mb-2">
                            Complete Set of 7 Books: 30 Days to Change Yourself
                    ...
                    {activeTab === "Description" && (
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                Point, Bryce showed her how much there was to
                                love about the wind-swept beach town--and
                                introduced her to photography, a passion that
                                would define the rest of her life. A collection
                                of 10 well-researched board books to introduce a
                                wide range of learning topics and everyday
                    ...
                    {activeTab === "Additional Information" && (
                        <div>
                            <p className="mb-4 opacity-80">
                                ...
                                <p>
                                    products, we have already made a big leap
                                    forward. This ranges from the
                                </p>{" "}
                                <p>
                                    increased use of more sustainable fibers to
                                    the use of more{"    "}
                                </p>{" "}
                                <p>
                            ...
                            {reviewSubmitted && (
                                <div className="w-full max-w-4xl mx-auto p-4 mb-8 bg-green-50 border-2 border-green-200 rounded-lg">
                                    ...
                                    <p className="text-sm text-green-700 mb-4">
                                        Thank you! Please refresh the page in a
                                        few moments to see your review. You can
                                        remove or edit your review by logging
                                        into{" "}
                                        <a
                                            href="#"
